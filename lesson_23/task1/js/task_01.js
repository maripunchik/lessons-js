...
const numbersInText = text.match(/\d/g); // g -- "знайди все"
...
const punctuationMarks = text.match(/[.,!?;:-_’()'"`]/g);
...
const message = "aaaa 2000 bbbbb 2024 ccccc 2030 vvv 2029 fff llkkll 2050";
const yearsAfter2021 = message.match(/20[3-9]\d|202[2-9]/g);
